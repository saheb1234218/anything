...
<div class="card w-75 " >
  ...
  <div  class="card-body  p-5 shadow flex-column align-items-center d-flex justify-content-center">
    ...
    <input onChange={(e)=>setName(e.target.value)} class="form-control comp form-control-lg w-sm-75 w-100  mt-2 shadow" type="text" placeholder="What is your full name? " aria-label=".form-control-lg example"/>
    <input onChange={(e)=>setEmail(e.target.value)} class="form-control comp form-control-lg w-sm-75 w-100 mt-2 shadow" type="email" placeholder="Add your email " aria-label=".form-control-lg example"/>
    <input onChange={(e)=>setPassword(e.target.value)} class="form-control comp form-control-lg w-sm-75 w-100 mt-2 shadow" type="password" placeholder="Add your password " aria-label=".form-control-lg example"/>
